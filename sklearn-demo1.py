...
print(X_train[:2, :]) # 输出前两个样本各个属性
print(y_train) #我们看到训练数据的特征值分为3类
'''
[0 1 0 0 2 0 1 1 0 1 1 2 0 2 0 0 2 0 2 2 2 2 0 2 2 0 0 0 1 2 0 1 0 1 1 1 1
 1 1 2 0 1 1 2 2 1 1 2 2 2 1 1 0 1 0 2 0 2 0 0 2 0 0 2 1 0 2 2 2 2 1 2 1 2
 0 0 1 0 2 2 0 1 1 2 2 2 1 1 0 1 2 0 2 0 1 2 1 1 0 1 1 0 0 0 0]
 已打乱
 '''
...
###预测数据###
print(knn.predict(X_test)) #根据训练出的模型预测特征值
'''
